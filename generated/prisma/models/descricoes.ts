...
// @ts-nocheck 
/*
 * This file exports the `descricoes` model and its related types.
 *
...
export type GetDescricoesAggregateType<T extends DescricoesAggregateArgs> = {
      [P in keyof T & keyof AggregateDescricoes]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDescricoes[P]>
    : Prisma.GetScalarType<T[P], AggregateDescricoes[P]>
}
...
export type GetDescricoesGroupByPayload<T extends descricoesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DescricoesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DescricoesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DescricoesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DescricoesGroupByOutputType[P]>
      }
    >
  >
...
export type descricoesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<descricoesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface descricoesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['descricoes'], meta: { name: 'descricoes' } }
  /**
   ...
   * })
  **/
  count<T extends descricoesCountArgs>(
    args?: Prisma.Subset<T, descricoesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DescricoesCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends descricoesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, descricoesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDescricoesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
